        ...
        <ul className="space-y-4">
          {threads.map((thread) => (
            <li key={thread.id} className="relative">
              ...
              >
                <AvatarView avatarUrl={thread.user.avatar_url} />
                ...
                {thread.unread_messages_count > 0 && (
                  <span className="absolute right-5 bottom-4 flex h-6 min-w-6 shrink-0 items-center justify-center rounded-full bg-emerald-600 px-2 text-xs font-semibold text-white">
